...
\usepackage{parskip} %Ajusta sangria
\setlength{\parindent}{0cm} %Ajusta sangria a 0 cm
...
\rfoot{\thepage} % Custom footer text
...
%reedifinición de nueva enumeración por secciones y subsecciones
